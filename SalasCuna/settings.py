...
ALLOWED_HOSTS = ['15.228.49.140', 'localhost']
...
DATABASES = {
    'default': {
        ...
        'USER': 'mysuperuser',
        'PASSWORD': 'pepe1234',
        'HOST': 'salaspostgres.cpew4ddmqibh.sa-east-1.rds.amazonaws.com',
        'PORT': '5432',
    }
}
...
AWS_ACCESS_KEY_ID = 'AKIA2FUBLBHL4OVTT427'
AWS_SECRET_ACCESS_KEY = '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'
AWS_STORAGE_BUCKET_NAME = 'salasbucket'
